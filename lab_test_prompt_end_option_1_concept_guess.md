Whenever your return a result, also include upto three synonyms or similar terms for both the event and the concept.
...
```json
{
  ...
  "concept": "<chosen LOINC concept long name, or null>",
